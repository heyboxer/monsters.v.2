...
var MonsterModel = /** @class */ (function () {
    ...
    MonsterModel.prototype.checkAnimationStack = function () {
        if (this.animationsArr.length !== 0) {
            var _a = this.animationsArr, fn = _a[0].fn, rest = _a.slice(1);
            this.animationsArr = rest;
            fn();
            return true;
        }
    };
    MonsterModel.prototype.loadAnimations = function (animations) {
        var _this = this;
        var partNames = Object.keys(animations);
        partNames.forEach(function (name) {
            var fn = animations[name].fn;
            var find = fn ? fn : function (part) { return part.name === name; };
            _this.getParts(find)
                .forEach(function (part) {
                return part.setAnimations(new __WEBPACK_IMPORTED_MODULE_2__animation_animation_set_controller__["a" /* AnimationSetController */](__WEBPACK_IMPORTED_MODULE_3_imports_loader_this_window_fix_module_exports_0_snapsvg_dist_snap_svg_js___default()(part.element), animations[name]));
            });
        });
    };
    MonsterModel.prototype.animateJoyful = function (arg, cb) {
        return;
    };
    MonsterModel.prototype.animateSad = function (arg, cb) {
        return;
    };
    MonsterModel.prototype.setAnimationStack = function (emotion, isForward) {
        var _this = this;
        ...
        var newElement = {
            ...
            arg: isForward,
            fn: (emotion === 'joyful' ?
                function () { return _this.animateJoyful(isForward); } :
                function () { return _this.animateSad(isForward); })
        };
        this.animationsArr = this.animationsArr.concat([newElement]);
        return;
    };
    ...
    MonsterModel.prototype.makeJoyful = function () {
        this.animateJoyful(true);
        this.emotion = 'joyful';
        return this;
    };
    MonsterModel.prototype.clearEmotion = function (cb) {
    ...
    MonsterModel.prototype.clearAll = function () {
        ...
        this.clearEmotion(function () {
            _this.getParts(function (p) { return p.animations; }).forEach(function (p) { return p.animations.recovery(); });
        });
        return;
    };
    __decorate([
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_game_game_service__ = __webpack_require__(305);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_game_game_logic__ = __webpack_require__(309);
...
var ZombieComponent = /** @class */ (function (_super) {
    ...
    ZombieComponent.prototype.ngAfterViewInit = function () {
        ...
        var defaultSeq = function () {
            ...
            __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].default(pupils, lids, function () {
    ...
    ZombieComponent.prototype.animateJoyful = function (arg) {
        var _this = this;
        ...
        var lids = this.getParts(function (p) { return p.name === 'lid'; });
        var mouth = this.getPart(function (p) { return p.name == 'mouth' && p.type == 'element'; });
        __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].joyful(lids, mouth, arg, function () {
            _this.isAnimating = false;
        });
        return;
    };
    ZombieComponent.prototype.animateSad = function (arg, cb) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
        ...
        var lids = this.getParts(function (p) { return p.name === 'lid'; });
        var mouth = this.getPart(function (p) { return p.name == 'mouth' && p.type == 'element'; });
        __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].sad(lids, mouth, arg, function () {
            _this.isAnimating = false;
            if (cb)
                cb();
        });
...
var SkeletonComponent = /** @class */ (function (_super) {
    ...
    SkeletonComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.loadAnimations(__WEBPACK_IMPORTED_MODULE_2__animations__["a" /* animations */]);
        var lidLeft = this.getPart(function (p) { return p.name === 'lid' && p.mod === 'left'; });
        var lidRight = this.getPart(function (p) { return p.name === 'lid' && p.mod === 'right'; });
        var defaultSeq = function () {
            if (_this.checkAnimationStack())
                return;
            _this.isAnimating = true;
            __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].default(lidLeft, lidRight, function () {
                _this.isAnimating = false;
                _this.checkAnimationStack();
                return;
            });
    ...
    SkeletonComponent.prototype.animateJoyful = function (arg) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
        ...
        var topTeeth = this.getPart(function (p) { return p.name == 'teeth-top'; });
        var bottomTeeth = this.getPart(function (p) { return p.name == 'teeth-bottom'; });
        arg ? this.open('hidden-jaw') : this.close('hidden-jaw');
        __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].joyful(mouth, topTeeth, bottomTeeth, arg, function () {
            _this.isAnimating = false;
        });
        return;
    };
    SkeletonComponent.prototype.animateSad = function (arg, cb) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
        ...
        var topTeeth = this.getPart(function (p) { return p.name == 'teeth-top'; });
        var bottomTeeth = this.getPart(function (p) { return p.name == 'teeth-bottom'; });
        __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].sad(mouth, topTeeth, bottomTeeth, arg, function () {
            _this.isAnimating = false;
...
var AlienComponent = /** @class */ (function (_super) {
    ...
    AlienComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.loadAnimations(__WEBPACK_IMPORTED_MODULE_2__animations__["a" /* animations */]);
        var lidLeft = this.getPart(function (p) { return p.name === 'lid' && p.mod === 'left'; });
        var lidRight = this.getPart(function (p) { return p.name === 'lid' && p.mod === 'right'; });
    ...
    AlienComponent.prototype.animateJoyful = function (arg) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
    ...
    AlienComponent.prototype.animateSad = function (arg, cb) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
        ...
        this.isAnimating = true;
        var mouth = this.getPart(function (p) { return p.name === 'mouth-figure'; });
        __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].sad(mouth, arg, function () {
            _this.isAnimating = false;
            if (cb)
                cb();
        });
...
var BedComponent = /** @class */ (function (_super) {
    ...
    BedComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.loadAnimations(__WEBPACK_IMPORTED_MODULE_2__animations__["a" /* animations */]);
        var lidLeft = this.getPart(function (p) { return p.name === 'lid' && p.mod === 'left'; });
        var lidRight = this.getPart(function (p) { return p.name === 'lid' && p.mod === 'right'; });
    ...
    BedComponent.prototype.animateJoyful = function (arg) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
        ...
        this.isAnimating = true;
        var mouth = this.getPart(function (p) { return p.name === 'mouth-figure'; });
        var teeth = this.getPart(function (p) { return p.name === 'mouth'; });
        __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].joyful(mouth, teeth, arg, function () {
            _this.isAnimating = false;
        });
        return;
    };
    BedComponent.prototype.animateSad = function (arg, cb) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
        ...
        var mouth = this.getPart(function (p) { return p.name === 'mouth-figure'; });
        var teeth = this.getPart(function (p) { return p.name === 'mouth'; });
        __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].sad(mouth, teeth, arg, function () {
            _this.isAnimating = false;
            if (cb)
                cb();
        });
...
var SpiderComponent = /** @class */ (function (_super) {
    ...
    SpiderComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.loadAnimations(__WEBPACK_IMPORTED_MODULE_2__animations__["a" /* animations */]);
        var lids = this.getParts(function (p) { return p.name === 'lid'; });
        var defaultSeq = function () {
    ...
    SpiderComponent.prototype.animateJoyful = function (arg) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
        ...
        this.isAnimating = true;
        var mouthTop = this.getPart(function (p) { return p.name === 'mouth-figure' && p.mod === 'top'; });
        var mouthBottom = this.getPart(function (p) { return p.name === 'mouth-figure' && p.mod === 'bottom'; });
        __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].joyful(mouthTop, mouthBottom, arg, function () {
            _this.isAnimating = false;
        });
        return;
    };
    SpiderComponent.prototype.animateSad = function (arg, cb) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
        ...
        var mouthTop = this.getPart(function (p) { return p.name === 'mouth-figure' && p.mod === 'top'; });
        var mouthBottom = this.getPart(function (p) { return p.name === 'mouth-figure' && p.mod === 'bottom'; });
        var teeth = this.getParts(function (p) { return p.name === 'teeth'; });
        __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].sad(mouthTop, mouthBottom, teeth, arg, function () {
            _this.isAnimating = false;
            if (cb)
                cb();
        });
...
var VampireComponent = /** @class */ (function (_super) {
    ...
    VampireComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.loadAnimations(__WEBPACK_IMPORTED_MODULE_2__animations__["a" /* animations */]);
        var lids = this.getParts(function (p) { return p.name === 'lid'; });
        var defaultSeq = function () {
    ...
    VampireComponent.prototype.animateJoyful = function (arg) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
    ...
    VampireComponent.prototype.animateSad = function (arg, cb) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
        ...
        this.isAnimating = true;
        var mouth = this.getPart(function (p) { return p.name === 'mouth-figure'; });
        var lidRight = this.getPart(function (p) { return p.name === 'sad-eyelid' && p.mod === 'right'; });
        var lidLeft = this.getPart(function (p) { return p.name === 'sad-eyelid' && p.mod === 'left'; });
        __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].sad(mouth, lidLeft, lidRight, arg, function () {
            _this.isAnimating = false;
            if (cb)
                cb();
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__monster_model__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__animations__ = __webpack_require__(299);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var WolfComponent = /** @class */ (function (_super) {
    ...
    WolfComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.loadAnimations(__WEBPACK_IMPORTED_MODULE_2__animations__["a" /* animations */]);
        var lidRight = this.getPart(function (p) { return p.name === 'lid' && p.mod === 'right'; });
        var lidLeft = this.getPart(function (p) { return p.name === 'lid' && p.mod === 'left'; });
        var defaultSeq = function () {
            if (_this.checkAnimationStack())
                return;
            _this.isAnimating = true;
            __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].default(lidRight, lidLeft, function () {
                _this.isAnimating = false;
                _this.checkAnimationStack();
                return;
            });
    ...
    WolfComponent.prototype.animateJoyful = function (arg, cb) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
                ...
                this.animationsArr.push({
                    emotion: 'joyful',
                    arg: arg,
                    fn: function () { return _this.animateJoyful(arg, cb); },
                }) : null;
        }
        this.isAnimating = true;
        var tongue = this.getPart(function (p) { return p.name === 'tongue'; });
        var smileTop = this.getPart(function (p) { return p.name === 'smile-part' && p.mod === 'top'; });
        var smileBottom = this.getPart(function (p) { return p.name === 'smile-part' && p.mod === 'bottom'; });
        __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].joyful(tongue, smileTop, smileBottom, arg, function () {
            _this.isAnimating = false;
            if (cb)
                cb();
        });
    ...
    WolfComponent.prototype.animateSad = function (arg, cb) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
        ...
        var eyeRight = this.getPart(function (p) { return p.name === 'eye' && p.mod === 'right'; });
        var eyeLeft = this.getPart(function (p) { return p.name === 'eye' && p.mod === 'left'; });
        var tongue = this.getPart(function (p) { return p.name === 'tongue'; });
        __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].sad(eyeLeft, eyeRight, tongue, arg, function () {
            _this.isAnimating = false;
            if (cb)
                cb();
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__monster_model__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__animations__ = __webpack_require__(300);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var MummyComponent = /** @class */ (function (_super) {
    ...
    MummyComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.loadAnimations(__WEBPACK_IMPORTED_MODULE_2__animations__["a" /* animations */]);
        var lids = this.getParts(function (p) { return p.name === 'lid'; });
        var defaultSeq = function () {
    ...
    MummyComponent.prototype.animateJoyful = function (arg) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
    ...
    MummyComponent.prototype.animateSad = function (arg, cb) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
        ...
        this.isAnimating = true;
        var mouth = this.getPart(function (p) { return p.name === 'mouth' && p.type === 'element'; });
        var tooth = this.getPart(function (p) { return p.name === 'tooth'; });
        arg ? this.open('hidden-jaw') : this.close('hidden-jaw');
        __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].sad(mouth, tooth, arg, function () {
            _this.isAnimating = false;
            if (cb)
                cb();
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__monster_model__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__animations__ = __webpack_require__(301);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var YagaComponent = /** @class */ (function (_super) {
    ...
    YagaComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.loadAnimations(__WEBPACK_IMPORTED_MODULE_2__animations__["a" /* animations */]);
        var lidLeft = this.getPart(function (p) { return p.name === 'lid' && p.mod === 'left'; });
        var lidRight = this.getPart(function (p) { return p.name === 'lid' && p.mod === 'right'; });
    ...
    YagaComponent.prototype.animateJoyful = function (arg) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
        ...
        this.isAnimating = true;
        var mouth = this.getPart(function (p) { return p.name == 'mouth-figure'; });
        var teeth = this.getParts(function (p) { return p.name == 'tooth'; });
        __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].joyful(mouth, teeth, arg, function () {
            _this.isAnimating = false;
        });
        return;
    };
    YagaComponent.prototype.animateSad = function (arg, cb) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__monster_model__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__animations__ = __webpack_require__(302);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var DoctorComponent = /** @class */ (function (_super) {
    ...
    DoctorComponent.prototype.animateJoyful = function (arg) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
    ...
    DoctorComponent.prototype.animateSad = function (arg, cb) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__monster_model__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__animations__ = __webpack_require__(303);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__monster_model__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__animations__ = __webpack_require__(304);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var GhostComponent = /** @class */ (function (_super) {
    ...
    GhostComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.loadAnimations(__WEBPACK_IMPORTED_MODULE_2__animations__["a" /* animations */]);
        var lids = this.getParts(function (p) { return p.name === 'lid'; });
        var defaultSeq = function () {
    ...
    GhostComponent.prototype.animateJoyful = function (arg) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
        ...
        this.isAnimating = true;
        var mouthFigure = this.getPart(function (p) { return p.name === 'mouth-figure'; });
        var mouth = this.getPart(function (p) { return p.name === 'mouth'; });
        var ubula = this.getPart(function (p) { return p.name === 'ubula'; });
        var teeth = this.getPart(function (p) { return p.name === 'teeth'; });
        var smileTooth = this.getPart(function (p) { return p.name === 'smile-tooth'; });
        __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].joyful(mouthFigure, mouth, ubula, teeth, smileTooth, arg, function () {
            _this.isAnimating = false;
        });
        return;
    };
    GhostComponent.prototype.animateSad = function (arg, cb) {
        var _this = this;
        if (arg === void 0) { arg = true; }
        if (this.isAnimating) {
            return !this.animationsArr.find(function (_a) {
        ...
        var teeth = this.getPart(function (p) { return p.name === 'teeth'; });
        var smileTooth = this.getPart(function (p) { return p.name === 'smile-tooth'; });
        __WEBPACK_IMPORTED_MODULE_2__animations__["b" /* sequances */].sad(mouthFigure, mouth, ubula, teeth, smileTooth, arg, function () {
            _this.isAnimating = false;
            if (cb)
                cb();
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_javascript_state_machine__ = __webpack_require__(307);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__listner_register_class__ = __webpack_require__(308);
var __assign = (this && this.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
        for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_components_module__ = __webpack_require__(337);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_select_background_bg_module__ = __webpack_require__(361);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__model_model_module__ = __webpack_require__(362);
...
var DelayModel = /** @class */ (function (_super) {
    __extends(DelayModel, _super);
    function DelayModel(interval) {
        var _this = _super.call(this, null, function (instance, callback) { return setTimeout(callback, _this.interval); }) || this;
        _this.interval = interval;
        return _this;
    }
    ;
    return DelayModel;
}(__WEBPACK_IMPORTED_MODULE_1__animation_model__["a" /* AnimationModel */]));
var AnimationSetController = /** @class */ (function () {
    ...
    AnimationSetController.prototype.delay = function (interval) {
        var _this = this;
        var delay = new DelayModel(interval);
        delay.onStart(function (animation) {
            _this.setState(true);
            _this.setCurrent(animation);
            return;
        });
        delay.onEnd(function (animation) {
            _this.setState(false);
            _this.setCurrent(null);
            return;
        });
...
var animations = {
    lid: {
        ...
        smileIn: function (l, cb) {
            l.attr({ cy: 132 });
            l.animate({ cy: 118 }, 200, cb);
        },
        smileOut: function (l, cb) {
            l.attr({ cy: 118 }),
                l.animate({ cy: 132 }, 200, function () {
                    l.attr({ cy: 64 });
                    return cb();
                });
        },
...
var sequances = {
    ...
    default: function (pupils, lids, cb) {
        ...
        setTimeout(function () {
            var count = 0;
            lids.forEach(function (l) {
                l.animations.onDisengage(function () {
                    count++;
...
var animations = {
    ...
    teeth: {
        fn: function (p) { return p.name === 'teeth-top' || p.name === 'teeth-bottom'; },
        addOutClassSync: function (instance, cb) {
            instance.attr({ class: 'teeth fadeOut' });
            return cb();
        },
        addInClassSync: function (instance, cb) {
            instance.attr({ class: 'teeth fadeIn' });
            return cb();
        },
        hideClassSync: function (instance, cb) {
            var c = instance.attr().class;
...
var animations = {
    lidLeft: {
        fn: function (p) { return p.name === 'lid' && p.mod === 'left'; },
        close: function (l, cb) {
            l.attr({
    ...
    lidRight: {
        fn: function (p) { return p.name === 'lid' && p.mod === 'right'; },
        close: function (l, cb) {
            l.attr({
...
var animations = {
    ...
    teeth: {
        fn: function (p) { return p.name === 'mouth'; },
        scaleIn: function (instance, cb) {
            instance.animate({
                transform: 's1.5,1.5'
            }, 200, cb);
        },
        scaleOut: function (instance, cb) {
            instance.animate({
                transform: 's1,1'
            }, 200, cb);
        },
        rotateInSync: function (instance, cb) {
            instance.attr({
                transform: 'r180 t0,12'
            });
            return cb();
        },
        rotateOutSync: function (instance, cb) {
            instance.attr({
                transform: 'r0 t0,0'
            });
            return cb();
...
var sequances = {
    ...
    sad: function (mouth, teeth, isForward, cb) {
        ...
        var mouthSeq = seq.reduce(function (acc, el) {
            return acc.run(el);
        }, mouth.animations);
...
var animations = {
    ...
    mouthTop: {
        fn: function (p) { return p.name === 'mouth-figure' && p.mod === 'top'; },
        smileIn: function (instance, cb) {
            instance.attr({
    ...
    mouthBottom: {
        fn: function (p) { return p.name === 'mouth-figure' && p.mod === 'bottom'; },
        smileIn: function (instance, cb) {
            instance.attr({
    ...
    teeth: {
        rotateInSync: function (instance, cb) {
            var _a = instance.attr(), x = _a["data-origin-x"], y = _a["data-origin-y"];
...
var sequances = {
    ...
    sad: function (mouthTop, mouthBottom, teeth, isForward, cb) {
        ...
        teeth.forEach(function (t) { return t.animations.run(config.teeth); });
        mouthTop.animations.run(config.mouth).onDisengage(afterFinish);
        mouthBottom.animations.run(config.mouth).onDisengage(afterFinish);
        return;
    },
    default: function (lids, cb) {
        ...
        lids.forEach(function (l) { return l.animations.run('close').delay(50).run('open').onDisengage(afterFinish); });
        return;
    },
};
...
var animations = {
    ...
    lidLeft: {
        fn: function (p) { return p.name === 'sad-eyelid' && p.mod === 'left'; },
        frownIn: function (instance, cb) {
            instance.attr({
    ...
    lidRight: {
        fn: function (p) { return p.name === 'sad-eyelid' && p.mod === 'right'; },
        frownIn: function (instance, cb) {
            instance.attr({
    ...
    mouth: {
        ...
        narrowOut: function (instance, cb) {
            instance.attr({
                d: 'M82,193.75v-1h42.86v1z'
            });
            instance.animate({
...
var sequances = {
    joyful: function (mouth, isForward, cb) {
        ...
        var seq = isForward ? [config.mouthFirst, config.mouthSecond] : [config.mouthSecond, config.mouthFirst];
        var finished = 0;
        var afterFinish = function () {
            finished++;
            if (finished === 1) {
...
var animations = {
    ...
    eyeLeft: {
        fn: function (p) { return p.name === 'eye' && p.mod === 'left'; },
        incline: function (instance, cb) {
            instance.attr({ transform: 'r0' });
            instance.animate({
                transform: 'r-10'
            }, 200, cb);
    ...
    eyeRight: {
        fn: function (p) { return p.name === 'eye' && p.mod === 'right'; },
        incline: function (instance, cb) {
            instance.attr({ transform: 'r0' });
            instance.animate({
                transform: 'r10'
    ...
    smileTop: {
        fn: function (p) { return p.name === 'smile-part' && p.mod === 'top'; },
        smileIn: function (instance, cb) {
            instance.attr({
    ...
    smileBottom: {
        fn: function (p) { return p.name === 'smile-part' && p.mod === 'bottom'; },
        smileIn: function (instance, cb) {
            instance.attr({
...
var animations = {
    ...
    mouth: {
        fn: function (p) { return p.name === 'mouth' && p.type === 'element'; },
        smileIn: function (instance, cb) {
...
var animations = {
    ...
    tooth: {
        ...
        translateToSad: function (instance, cb) {
            instance.attr({ transform: 't25,48.5' });
            return cb();
        },
        translateToDefault: function (instance, cb) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cursor_position__ = __webpack_require__(306);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__active_element_repository__ = __webpack_require__(310);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__game_fsm__ = __webpack_require__(182);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__listners_handler__ = __webpack_require__(183);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__active_element_model__ = __webpack_require__(311);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__monsters_monsters_module__ = __webpack_require__(338);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__trinkets_trinkets_module__ = __webpack_require__(339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__game_game_module__ = __webpack_require__(359);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__item_holder_item_holder_module__ = __webpack_require__(360);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__glass_glass__ = __webpack_require__(340);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__eyes_eyes__ = __webpack_require__(341);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__hood_hood__ = __webpack_require__(342);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__beard_beard__ = __webpack_require__(343);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__moustache_moustache__ = __webpack_require__(344);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__snivel_snivel__ = __webpack_require__(345);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__dress_dress__ = __webpack_require__(346);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__bra_bra__ = __webpack_require__(347);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__wig_wig__ = __webpack_require__(348);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__lips_lips__ = __webpack_require__(349);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__lollipop_lollipop__ = __webpack_require__(350);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__egg_egg__ = __webpack_require__(351);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__earrings_earrings__ = __webpack_require__(352);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__necklace_necklace__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__flatulence_flatulence__ = __webpack_require__(354);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__flower_flower__ = __webpack_require__(355);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__bubble_bubble__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pigtail_pigtail__ = __webpack_require__(357);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__trinket_random_part_directive__ = __webpack_require__(358);
